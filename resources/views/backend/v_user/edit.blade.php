                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <!-- Preview Foto -->
                                        @if ($edit->foto)
                                            <img id="foto-preview" src="{{ asset('storage/img-user/' . $edit->foto) }}"
                                                 alt="Foto User" class="img-thumbnail mb-2" style="max-width: 100%;">
                                        @else
                                            <img id="foto-preview" src="{{ asset('storage/img-user/img-default.jpg') }}"
                                                 alt="Default Foto" class="img-thumbnail mb-2" style="max-width: 100%;">
                                        @endif
